...
namespace math
{
    ...
    struct [[nodiscard]] vec2
    {
        ...
        explicit constexpr  vec2(double value)  noexcept : vec2(value, value) {}  //delegating constructor
    ...
    struct [[nodiscard]] ivec2
    {
        ...
        explicit constexpr  ivec2(int value)  noexcept : ivec2(value, value) {}  //delegating constructor
